...
try {
    ...
    $packages = $repo_obj->getRepoX86_64Only($repo);
} catch (Exception $e) {
    die("Error: " . $e->getMessage());
}

Layout::header($repo . ' Repository - x86_64 Only Packages');
?>

<div class="container">
    <div class="card">
        <h2>⚠️ <?php echo ucfirst(Formatter::escape($repo)); ?> Repository - x86_64 Only (<?php echo count($packages); ?>)</h2>
        <p style="margin-bottom: 15px; opacity: 0.8;">Packages in this repository on x86_64 but not on aarch64</p>
